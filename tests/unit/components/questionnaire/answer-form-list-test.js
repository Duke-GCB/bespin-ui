...
module('Unit | Component | questionnaire/answer form list', function(hooks) {
  setupTest(hooks);

  test('it renders', function(assert) {

    // Creates the component instance
    /*let component =*/ this.owner.factoryFor('component:questionnaire/answer-form-list').create();
  ...
  test('it computes fields property', function (assert) {
    ...
    let component = this.owner.factoryFor('component:questionnaire/answer-form-list').create({answerSet: answerSet});
  ...
  test('it sets stageGroup on answerChanged', function(assert) {
    ...
    const component = this.owner.factoryFor('component:questionnaire/answer-form-list').create({answerSet: answerSet});
