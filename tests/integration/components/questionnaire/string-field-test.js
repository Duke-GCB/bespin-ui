...
module('Integration | Component | questionnaire/string field', function(hooks) {
  setupRenderingTest(hooks);

  test('it renders', async function(assert) {
    this.set('fieldName', 'field');
    this.set('externalAction', () => {});
    await render(hbs`{{questionnaire/string-field fieldName (action externalAction) }}`);
  ...
  test('it renders with label when provided', async function(assert) {
    this.set('fieldName', 'field');
    this.set('externalAction', () => {});
    await render(hbs`{{questionnaire/string-field fieldName (action externalAction) fieldLabel="MyLabel"}}`);
  ...
  test('it shows/hides errors based on answerFormErrors.show', async function(assert) {
    ...
    this.set('answerFormErrors', EmberObject.create({
      ...
      await render(hbs`{{questionnaire/string-field fieldName=fieldName answerChanged=(action externalAction)
