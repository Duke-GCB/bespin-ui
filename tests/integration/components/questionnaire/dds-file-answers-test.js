...
test('it calls onCancel when cancel button clicked', function(assert) {
  ...
  this.render(hbs`{{questionnaire/dds-file-answers 0 onAnswer onCancel store=store}}`);
...
test('it calls onAnswer when next button clicked', function(assert) {
  ...
  this.render(hbs`{{questionnaire/dds-file-answers 0 onAnswer onCancel store=store answers=[]}}`);
...
test('it enables next button when isValid', function(assert) {
  ...
  this.render(hbs`{{questionnaire/dds-file-answers occurs onAnswer onCancel pickedFiles=pickedFiles store=store}}`);
