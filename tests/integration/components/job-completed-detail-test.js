...
module('Integration | Component | job completed detail', function(hooks) {
  setupRenderingTest(hooks);

  test('it renders two paragraphs', async function(assert) {
    await render(hbs`{{job-completed-detail}}`);
  ...
  test('it renders share group', async function(assert) {
    ...
    await render(hbs`{{job-completed-detail shareGroup email}}`);
